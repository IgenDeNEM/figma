addEvent("tryToStartPumpkinOpening", true)
addEventHandler("tryToStartPumpkinOpening", getRootElement(), function(dbID)
    if exports.sItems:takeItem(source, "dbID", dbID, 1) then
        ...
        triggerClientEvent(source, "startPumpkinOpening", source, itemId, rnd1, rnd2, rnd3, rnd4, rnd5)
        ...
        exports.sAnticheat:anticheatBan(client, "AC #132 - sPumpkin @sourceS:27")
    end
end)